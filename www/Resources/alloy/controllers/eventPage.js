function Controller() {
    ...
    $.__views.actionBtns.add($.__views.__alloyId9);
    comment ? $.__views.__alloyId9.addEventListener("click", comment) : __defers["$.__views.__alloyId9!click!comment"] = true;
    ...
    $.__views.actionBtns.add($.__views.__alloyId10);
    ...
    __defers["$.__views.__alloyId9!click!comment"] && $.__views.__alloyId9.addEventListener("click", comment);
