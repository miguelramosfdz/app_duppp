function Controller() {
    ...
    $.__views.userLogin.add($.__views.__alloyId29);
    $.__views.headImage = Ti.UI.createImageView({
        id: "headImage",
        image: "bg.jpg"
    });
    $.__views.__alloyId29.add($.__views.headImage);
    ...
    openLoginDuppp ? $.__views.__alloyId30.addEventListener("click", openLoginDuppp) : __defers["$.__views.__alloyId30!click!openLoginDuppp"] = true;
    ...
    openRegisterDuppp ? $.__views.__alloyId31.addEventListener("click", openRegisterDuppp) : __defers["$.__views.__alloyId31!click!openRegisterDuppp"] = true;
    ...
    $.__views.userLoginDuppp.add($.__views.__alloyId32);
    ...
    $.__views.__alloyId32.add($.__views.loginUsr);
    ...
    $.__views.__alloyId32.add($.__views.loginPwd);
    ...
    $.__views.__alloyId32.add($.__views.loginBtn);
    ...
    $.__views.userRegisterDuppp.add($.__views.__alloyId33);
    ...
    $.__views.__alloyId33.add($.__views.usernameField);
    ...
    $.__views.__alloyId33.add($.__views.emailField);
    ...
    $.__views.__alloyId33.add($.__views.passwordRegisterField);
    ...
    $.__views.__alloyId33.add($.__views.registerBtn);
    ...
    __defers["$.__views.__alloyId30!click!openLoginDuppp"] && $.__views.__alloyId30.addEventListener("click", openLoginDuppp);
    __defers["$.__views.__alloyId31!click!openRegisterDuppp"] && $.__views.__alloyId31.addEventListener("click", openRegisterDuppp);
