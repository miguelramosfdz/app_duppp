function Controller() {
    ...
    openLoginDuppp ? $.__views.__alloyId28.addEventListener("click", openLoginDuppp) : __defers["$.__views.__alloyId28!click!openLoginDuppp"] = true;
    ...
    openRegisterDuppp ? $.__views.__alloyId29.addEventListener("click", openRegisterDuppp) : __defers["$.__views.__alloyId29!click!openRegisterDuppp"] = true;
    ...
    $.__views.userLoginDuppp.add($.__views.__alloyId30);
    ...
    $.__views.__alloyId30.add($.__views.loginUsr);
    ...
    $.__views.__alloyId30.add($.__views.loginPwd);
    ...
    $.__views.__alloyId30.add($.__views.loginBtn);
    ...
    $.__views.userRegisterDuppp.add($.__views.__alloyId31);
    ...
    $.__views.__alloyId31.add($.__views.usernameField);
    ...
    $.__views.__alloyId31.add($.__views.emailField);
    ...
    $.__views.__alloyId31.add($.__views.passwordRegisterField);
    ...
    $.__views.__alloyId31.add($.__views.registerBtn);
    ...
    __defers["$.__views.__alloyId28!click!openLoginDuppp"] && $.__views.__alloyId28.addEventListener("click", openLoginDuppp);
    __defers["$.__views.__alloyId29!click!openRegisterDuppp"] && $.__views.__alloyId29.addEventListener("click", openRegisterDuppp);
